...
export const BREEDS = freeze([
	...
	breed("Cirrus", 27, ANCIENT, COMMON),
...
export const GENES = freeze({
	primary: freeze([
		...
		gene("Arc", LIMITED, CIRRUS, 416, DUSTHIDE, 306, VEILSPUN, 70),
		gene("Bar", UNCOMMON, MODERN, 6, ABERRATION, 89, AETHER, 150, AURABOA, 238, BANESCALE, 181, CIRRUS, 417, DUSTHIDE, 292, EVERLUX, 346, GAOLER, 34, SANDSURGE, 444, UNDERTIDE, 117, VEILSPUN, 145),
		gene("Basic"),
		...
		gene("Caterpillar", COMMON, ABERRATION, 386, AETHER, 387, AURABOA, 241, BANESCALE, 388, DUSTHIDE, 389, EVERLUX, 347, GAOLER, 391, SANDSURGE, 392, UNDERTIDE, 390, VEILSPUN, 385),
		gene("Checkers", COMMON, MODERN, 412, AETHER, 319, DUSTHIDE, 293, GAOLER, 378, SANDSURGE, 440, UNDERTIDE, 127),
		gene("Cherub", UNCOMMON, MODERN, 10, ABERRATION, 221, BANESCALE, 43, CIRRUS, 419, DUSTHIDE, 340, EVERLUX, 348, SANDSURGE, 190, UNDERTIDE, 119, VEILSPUN, 339),
		gene("Chevron", UNCOMMON, BANESCALE, 54),
		gene("Chorus", UNCOMMON, MODERN, 337, CIRRUS, 420, VEILSPUN, 338),
		gene("Chrysocolla", LIMITED, MODERN, 237, AETHER, 320, EVERLUX, 350, SANDSURGE, 195, UNDERTIDE, 264),
		gene("Cinder", UNCOMMON, MODERN, 213, ABERRATION, 214, AETHER, 163, BANESCALE, 215, CIRRUS, 421, DUSTHIDE, 295, GAOLER, 216, SANDSURGE, 217, UNDERTIDE, 218, VEILSPUN, 219),
		gene("Clown", COMMON, MODERN, 3, ABERRATION, 222, AETHER, 169, BANESCALE, 75, GAOLER, 77, SANDSURGE, 196, UNDERTIDE, 265, VEILSPUN, 76),
		gene("Criculaworm", UNCOMMON, CIRRUS, 414, EVERLUX, 351),
		gene("Crystal", RARE, MODERN, 7, ABERRATION, 91, AETHER, 321, BANESCALE, 182, EVERLUX, 352, GAOLER, 37, SANDSURGE, 399, UNDERTIDE, 118, VEILSPUN, 146),
		gene("Diamond", LIMITED, ABERRATION, 93),
		gene("Display", LIMITED, DUSTHIDE, 317),
		gene("Fade", COMMON, MODERN, 42, ABERRATION, 90, AETHER, 148, AURABOA, 242, BANESCALE, 85, CIRRUS, 422, DUSTHIDE, 296, EVERLUX, 353, GAOLER, 86, SANDSURGE, 191, UNDERTIDE, 115, VEILSPUN, 60),
		gene("Faire", UNCOMMON, CIRRUS, 418),
		gene("Falcon", COMMON, MODERN, 16, ABERRATION, 92, AETHER, 322, AURABOA, 243, BANESCALE, 80, DUSTHIDE, 301, GAOLER, 30, SANDSURGE, 448, UNDERTIDE, 122, VEILSPUN, 139),
		gene("Fern", LIMITED, MODERN, 136, ABERRATION, 223, AETHER, 323, AURABOA, 244, BANESCALE, 137, SANDSURGE, 394, UNDERTIDE, 266, VEILSPUN, 138),
		gene("Flaunt", UNCOMMON, MODERN, 82, ABERRATION, 112, AETHER, 149, AURABOA, 245, CIRRUS, 423, EVERLUX, 354, GAOLER, 111, SANDSURGE, 193, UNDERTIDE, 267),
		...
		gene("Ground", LIMITED, MODERN, 88, ABERRATION, 97, AETHER, 325, DUSTHIDE, 299, SANDSURGE, 186, UNDERTIDE, 268, VEILSPUN, 382),
		gene("Harlequin", RARE, MODERN, 170, ABERRATION, 224, AETHER, 326, AURABOA, 247, CIRRUS, 427, DUSTHIDE, 298, GAOLER, 379, SANDSURGE, 192, UNDERTIDE, 280),
		gene("Ink", UNCOMMON, CIRRUS, 426),
		gene("Iridescent", RARE, MODERN, 1),
		gene("Jaguar", UNCOMMON, MODERN, 19, ABERRATION, 99, AETHER, 152, AURABOA, 248, BANESCALE, 44, GAOLER, 33, SANDSURGE, 198, UNDERTIDE, 269, VEILSPUN, 376),
		...
		gene("Lionfish", UNCOMMON, MODERN, 25, ABERRATION, 100, AETHER, 158, EVERLUX, 357, GAOLER, 380, SANDSURGE, 199, UNDERTIDE, 126),
		gene("Love", LIMITED, MODERN, 411, AURABOA, 279),
		gene("Marble", COMMON, BANESCALE, 47, CIRRUS, 424, EVERLUX, 358),
		gene("Metallic", RARE, MODERN, 17, AETHER, 157, AURABOA, 250, BANESCALE, 49, CIRRUS, 429, UNDERTIDE, 278),
		...
		gene("Orb", LIMITED, MODERN, 283, ABERRATION, 102, AETHER, 288, AURABOA, 253, BANESCALE, 287, CIRRUS, 425, DUSTHIDE, 303, GAOLER, 286, SANDSURGE, 284, UNDERTIDE, 271, VEILSPUN, 285),
		gene("Papillon", LIMITED, EVERLUX, 359),
		gene("Petals", RARE, MODERN, 13, AETHER, 154, BANESCALE, 51, DUSTHIDE, 304, EVERLUX, 360, SANDSURGE, 446, UNDERTIDE, 281, VEILSPUN, 143),
		gene("Petrified", RARE, MODERN, 318, DUSTHIDE, 309, EVERLUX, 361, SANDSURGE, 449),
		gene("Phantom", LIMITED, GAOLER, 39),
		gene("Pharaoh", RARE, MODERN, 87, ABERRATION, 101, BANESCALE, 185, EVERLUX, 362, UNDERTIDE, 120, VEILSPUN, 383),
		gene("Piebald", COMMON, MODERN, 9, AETHER, 159, AURABOA, 254, CIRRUS, 428, DUSTHIDE, 305, EVERLUX, 363, GAOLER, 31, SANDSURGE, 201, UNDERTIDE, 272),
		...
		gene("Python", LIMITED, MODERN, 23, AETHER, 160, AURABOA, 255, CIRRUS, 430, EVERLUX, 364, SANDSURGE, 203),
		gene("Rabicano", COMMON, CIRRUS, 439),
		gene("Ragged", UNCOMMON, BANESCALE, 56, CIRRUS, 431, SANDSURGE, 445),
		gene("Rattlesnake", UNCOMMON, AURABOA, 256, SANDSURGE, 206),
		gene("Ribbon", UNCOMMON, MODERN, 84, ABERRATION, 105, AETHER, 327, BANESCALE, 183, DUSTHIDE, 311, GAOLER, 175, SANDSURGE, 447, UNDERTIDE, 124),
		gene("Ripple", UNCOMMON, MODERN, 5, ABERRATION, 228, AETHER, 328, AURABOA, 257, BANESCALE, 79, CIRRUS, 432, DUSTHIDE, 312, EVERLUX, 366, GAOLER, 78, UNDERTIDE, 130),
		gene("Sailfish", LIMITED, DUSTHIDE, 313, SANDSURGE, 212),
		gene("Savannah", COMMON, MODERN, 18, ABERRATION, 103, AETHER, 329, BANESCALE, 50, CIRRUS, 415, DUSTHIDE, 314, GAOLER, 176, SANDSURGE, 204, UNDERTIDE, 129),
		gene("Shaggy", COMMON, GAOLER, 29),
		gene("Shell", UNCOMMON, VEILSPUN, 71),
		gene("Skink", LIMITED, MODERN, 15, ABERRATION, 229, AETHER, 161, BANESCALE, 52, CIRRUS, 437, DUSTHIDE, 315, EVERLUX, 367, GAOLER, 177, SANDSURGE, 441, VEILSPUN, 67),
		gene("Slime", LIMITED, MODERN, 41, ABERRATION, 106, AETHER, 336, EVERLUX, 368, GAOLER, 178, SANDSURGE, 208, VEILSPUN, 141),
		gene("Soil", LIMITED, MODERN, 400, ABERRATION, 401, AETHER, 402, AURABOA, 403, BANESCALE, 404, CIRRUS, 438, DUSTHIDE, 405, EVERLUX, 410, GAOLER, 406, SANDSURGE, 407, UNDERTIDE, 408, VEILSPUN, 409),
		gene("Speckle", COMMON, MODERN, 4, ABERRATION, 98, BANESCALE, 147, DUSTHIDE, 294, UNDERTIDE, 132, VEILSPUN, 144),
		gene("Sphinxmoth", UNCOMMON, EVERLUX, 369, SANDSURGE, 443, VEILSPUN, 72),
		...
		gene("Tiger", COMMON, MODERN, 2, AETHER, 331, AURABOA, 259, BANESCALE, 46, CIRRUS, 436, EVERLUX, 374, GAOLER, 36, SANDSURGE, 211, UNDERTIDE, 275),
		gene("Twinkle", RARE, AETHER, 166),
		gene("Varnish", COMMON, MODERN, 450, ABBERATION, 451, AETHER, 332, AURABOA, 261, BANESCALE, 452, CIRRUS, 435, DUSTHIDE, 316, GAOLER, 381, EVERLUX, 375, SANDSURGE, 442, UNDERTIDE, 276, VEILSPUN, 453),
		gene("Vipera", UNCOMMON, MODERN, 8, ABERRATION, 96, AETHER, 333, AURABOA, 260, BANESCALE, 395, CIRRUS, 434, GAOLER, 396, SANDSURGE, 397, UNDERTIDE, 398, VEILSPUN, 63),
		gene("Wasp", RARE, MODERN, 20, ABERRATION, 108, AETHER, 334, CIRRUS, 433, DUSTHIDE, 310, GAOLER, 28, SANDSURGE, 207, UNDERTIDE, 125, VEILSPUN, 68),
		gene("Wicker", RARE, AURABOA, 262),
		gene("Wolf", UNCOMMON, UNDERTIDE, 116),
		gene("Wrought", COMMON, AETHER, 335, DUSTHIDE, 307, SANDSURGE, 187, UNDERTIDE, 277, VEILSPUN, 384)
	]),
	secondary: freeze([
		gene("Affection", LIMITED, MODERN, 411, AURABOA, 279),
		gene("Alloy", RARE, MODERN, 17, AETHER, 157, AURABOA, 250, BANESCALE, 49, CIRRUS, 429, UNDERTIDE, 278),
		gene("Arowana", COMMON, EVERLUX, 345, SANDSURGE, 194),
		gene("Arrow", UNCOMMON, BANESCALE, 54),
		gene("Basic"),
		gene("Bee", RARE, MODERN, 20, ABERRATION, 108, AETHER, 319, CIRRUS, 433, DUSTHIDE, 310, GAOLER, 28, SANDSURGE, 207, UNDERTIDE, 125, VEILSPUN, 60),
		gene("Blaze", UNCOMMON, MODERN, 213, ABERRATION, 214, AETHER, 163, BANESCALE, 215, CIRRUS, 421, DUSTHIDE, 295, GAOLER, 216, SANDSURGE, 217, UNDERTIDE, 218, VEILSPUN, 219),
		gene("Blend", COMMON, MODERN, 42, ABERRATION, 91, AETHER, 148, AURABOA, 242, BANESCALE, 85, CIRRUS, 422, DUSTHIDE, 296, EVERLUX, 347, GAOLER, 86, SANDSURGE, 191, UNDERTIDE, 115, VEILSPUN, 61),
		...
		gene("Butterfly", RARE, MODERN, 13, AETHER, 154, BANESCALE, 51, DUSTHIDE, 304, EVERLUX, 359, SANDSURGE, 446, UNDERTIDE, 281, VEILSPUN, 144),
		gene("Carousel", UNCOMMON, CIRRUS, 418),
		gene("Chess", COMMON, MODERN, 412, AETHER, 320, DUSTHIDE, 293, GAOLER, 379, SANDSURGE, 440, UNDERTIDE, 127),
		...
		gene("Current", UNCOMMON, MODERN, 6, ABERRATION, 222, AETHER, 321, AURABOA, 257, BANESCALE, 79, CIRRUS, 432, DUSTHIDE, 312, EVERLUX, 366, GAOLER, 78, UNDERTIDE, 130),
		gene("Daub", UNCOMMON, MODERN, 7, ABERRATION, 89, AETHER, 150, AURABOA, 238, BANESCALE, 181, CIRRUS, 417, DUSTHIDE, 292, EVERLUX, 348, GAOLER, 34, SANDSURGE, 444, UNDERTIDE, 117, VEILSPUN, 145),
		gene("Diamondback", UNCOMMON, AURABOA, 256, SANDSURGE, 206),
		gene("Dye", UNCOMMON, CIRRUS, 426),
		gene("Edged", COMMON, MODERN, 26, AETHER, 156, AURABOA, 249, BANESCALE, 48, DUSTHIDE, 302, EVERLUX, 355, GAOLER, 73, VEILSPUN, 62),
		gene("Eel", UNCOMMON, MODERN, 84, ABERRATION, 105, AETHER, 322, BANESCALE, 183, DUSTHIDE, 311, GAOLER, 174, SANDSURGE, 447, UNDERTIDE, 124),
		gene("Eye Spots", COMMON, MODERN, 3, ABERRATION, 223, AETHER, 169, BANESCALE, 75, GAOLER, 77, SANDSURGE, 196, UNDERTIDE, 265, VEILSPUN, 76),
		gene("Facet", RARE, MODERN, 8, ABERRATION, 90, AETHER, 323, BANESCALE, 182, EVERLUX, 349, GAOLER, 37, SANDSURGE, 399, UNDERTIDE, 118, VEILSPUN, 146),
		gene("Fissure", LIMITED, MODERN, 88, ABERRATION, 97, AETHER, 324, DUSTHIDE, 298, SANDSURGE, 186, UNDERTIDE, 268, VEILSPUN, 377),
		gene("Flair", UNCOMMON, MODERN, 82, ABERRATION, 112, AETHER, 149, AURABOA, 245, CIRRUS, 423, EVERLUX, 350, GAOLER, 111, SANDSURGE, 193, UNDERTIDE, 267),
		...
		gene("Hawkmoth", UNCOMMON, EVERLUX, 369, SANDSURGE, 443, VEILSPUN, 72),
		...
		gene("Hypnotic", UNCOMMON, MODERN, 9, ABERRATION, 96, AETHER, 326, AURABOA, 260, BANESCALE, 395, CIRRUS, 434, GAOLER, 396, SANDSURGE, 397, UNDERTIDE, 398, VEILSPUN, 64),
		gene("Icing", LIMITED, AETHER, 167),
		gene("Jester", RARE, MODERN, 170, ABERRATION, 225, AETHER, 327, AURABOA, 247, CIRRUS, 427, DUSTHIDE, 299, GAOLER, 380, SANDSURGE, 192, UNDERTIDE, 282),
		gene("Lacquer", COMMON, MODERN, 450, ABBERATION, 451, AETHER, 328, AURABOA, 241, BANESCALE, 452, CIRRUS, 435, DUSTHIDE, 316, EVERLUX, 376, GAOLER, 382, SANDSURGE, 442, UNDERTIDE, 276, VEILSPUN, 453),
		gene("Larvae", COMMON, ABERRATION, 386, AETHER, 387, AURABOA, 261, BANESCALE, 388, DUSTHIDE, 389, EVERLUX, 351, GAOLER, 392, SANDSURGE, 391, UNDERTIDE, 390, VEILSPUN, 385),
		gene("Loam", LIMITED, MODERN, 400, ABERRATION, 401, AETHER, 402, AURABOA, 403, BANESCALE, 404, CIRRUS, 438, DUSTHIDE, 405, EVERLUX, 410, GAOLER, 406, SANDSURGE, 407, UNDERTIDE, 408, VEILSPUN, 409),
		gene("Lode", RARE, MODERN, 318, DUSTHIDE, 309, EVERLUX, 360, SANDSURGE, 449),
		gene("Loop", LIMITED, CIRRUS, 416, DUSTHIDE, 306, VEILSPUN, 70),
		...
		gene("Morph", LIMITED, MODERN, 23, AETHER, 160, AURABOA, 255, CIRRUS, 430, EVERLUX, 362, SANDSURGE, 203),
		gene("Mottle", COMMON, BANESCALE, 47, CIRRUS, 424, EVERLUX, 356),
		...
		gene("Noxtide", UNCOMMON, MODERN, 24, ABERRATION, 100, AETHER, 158, EVERLUX, 357, GAOLER, 381, SANDSURGE, 199, UNDERTIDE, 126),
		gene("Pack", UNCOMMON, UNDERTIDE, 116),
		gene("Paint", COMMON, MODERN, 10, AETHER, 159, AURABOA, 254, DUSTHIDE, 305, CIRRUS, 428, EVERLUX, 361, GAOLER, 31, SANDSURGE, 201, UNDERTIDE, 272),
		gene("Paisley", LIMITED, MODERN, 136, ABERRATION, 227, AETHER, 330, AURABOA, 244, BANESCALE, 137, SANDSURGE, 394, UNDERTIDE, 266, VEILSPUN, 138),
		...
		gene("Peregrine", COMMON, MODERN, 11, ABERRATION, 92, AETHER, 331, AURABOA, 243, BANESCALE, 80, DUSTHIDE, 301, GAOLER, 30, SANDSURGE, 448, UNDERTIDE, 122, VEILSPUN, 139),
		gene("Rings", LIMITED, UNDERTIDE, 133),
		gene("Riopa", UNCOMMON, AURABOA, 251),
		gene("Roan", COMMON, CIRRUS, 439),
		gene("Rosette", UNCOMMON, MODERN, 19, ABERRATION, 99, AETHER, 152, AURABOA, 248, BANESCALE, 44, GAOLER, 33, SANDSURGE, 198, UNDERTIDE, 269, VEILSPUN, 383),
		...
		gene("Safari", COMMON, MODERN, 18, ABERRATION, 104, AETHER, 332, BANESCALE, 50, CIRRUS, 415, DUSTHIDE, 314, GAOLER, 175, SANDSURGE, 204, UNDERTIDE, 129),
		gene("Sarcophagus", RARE, MODERN, 87, ABERRATION, 101, BANESCALE, 185, EVERLUX, 363, UNDERTIDE, 120, VEILSPUN, 365),
		gene("Saturn", UNCOMMON, MODERN, 15, AETHER, 153, DUSTHIDE, 300, EVERLUX, 358, SANDSURGE, 197, UNDERTIDE, 270, VEILSPUN, 65),
		gene("Seraph", UNCOMMON, MODERN, 5, ABERRATION, 228, BANESCALE, 43, CIRRUS, 419, DUSTHIDE, 340, EVERLUX, 353, SANDSURGE, 190, UNDERTIDE, 119, VEILSPUN, 339),
		gene("Shimmer", RARE, MODERN, 1),
		gene("Silkspot", UNCOMMON, CIRRUS, 414, EVERLUX, 354),
		...
		gene("Spinner", LIMITED, MODERN, 16, ABERRATION, 229, AETHER, 161, BANESCALE, 52, CIRRUS, 437, DUSTHIDE, 315, EVERLUX, 367, GAOLER, 176, SANDSURGE, 441, VEILSPUN, 68),
		gene("Spire", COMMON, AETHER, 335, DUSTHIDE, 307, SANDSURGE, 187, UNDERTIDE, 277, VEILSPUN, 384),
		...
		gene("Stripes", COMMON, MODERN, 2, AETHER, 334, AURABOA, 259, BANESCALE, 46, CIRRUS, 436, EVERLUX, 374, GAOLER, 36, SANDSURGE, 211, UNDERTIDE, 275),
		gene("Sugarplum", LIMITED, BANESCALE, 55),
		gene("Swallowtail", LIMITED, EVERLUX, 364),
		gene("Tear", UNCOMMON, BANESCALE, 56, CIRRUS, 431, SANDSURGE, 445),
		...
		gene("Weaver", LIMITED, MODERN, 283, ABERRATION, 102, AETHER, 284, AURABOA, 253, BANESCALE, 285, CIRRUS, 425, DUSTHIDE, 303, GAOLER, 286, SANDSURGE, 287, UNDERTIDE, 271, VEILSPUN, 288),
	...
	tertiary: freeze([
		...
		gene("Basic"),
		gene("Batty", LIMITED, AURABOA, 214, DUSTHIDE, 289, EVERLUX, 351, SANDSURGE, 470),
		gene("Beard", UNCOMMON, SANDSURGE, 174),
		gene("Beetle", LIMITED, VEILSPUN, 65),
		gene("Blossom", LIMITED, ABERRATION, 399, AURABOA, 400, AETHER, 336, BANESCALE, 401, CIRRUS, 435, DUSTHIDE, 281, GAOLER, 36, SANDSURGE, 398, UNDERTIDE, 267, VEILSPUN, 396),
		gene("Braids", UNCOMMON, ABERRATION, 199, AETHER, 317, CIRRUS, 436, GAOLER, 55),
		gene("Branches", LIMITED, AETHER, 318, AURABOA, 217, GAOLER, 386, SANDSURGE, 189, UNDERTIDE, 248, VEILSPUN, 63),
		gene("Brightshine", LIMITED, BANESCALE, 310, CIRRUS, 466, DUSTHIDE, 309, EVERLUX, 465, UNDERTIDE, 170, VEILSPUN, 169),
		gene("Capsule", LIMITED, MODERN, 18, ABERRATION, 83, AETHER, 319, AURABOA, 229, BANESCALE, 74, GAOLER, 75, SANDSURGE, 410, UNDERTIDE, 111, VEILSPUN, 56),
		gene("Carnivore", LIMITED, ABERRATION, 162, AETHER, 163, BANESCALE, 164, DUSTHIDE, 282, GAOLER, 166, SANDSURGE, 403, UNDERTIDE, 165, VEILSPUN, 167),
		gene("Chitin", COMMON, EVERLUX, 352, SANDSURGE, 183),
		gene("Circuit", RARE, MODERN, 1, AETHER, 135, GAOLER, 387, UNDERTIDE, 117),
		gene("Contour", COMMON, MODERN, 13, ABERRATION, 200, AETHER, 136, AURABOA, 230, BANESCALE, 46, GAOLER, 157, UNDERTIDE, 249, VEILSPUN, 392),
		gene("Coral", LIMITED, CIRRUS, 437),
		gene("Crackle", UNCOMMON, MODERN, 6, AETHER, 320, AURABOA, 231, BANESCALE, 50, CIRRUS, 438, UNDERTIDE, 115, VEILSPUN, 58),
		gene("Crest", UNCOMMON, AURABOA, 215, SANDSURGE, 184, UNDERTIDE, 250),
		gene("Crystalline", LIMITED, AETHER, 424, AURABOA, 266, EVERLUX, 425, GAOLER, 265),
		gene("Darts", COMMON, SANDSURGE, 177),
		gene("Deco", RARE, CIRRUS, 440),
		gene("Dewlap", LIMITED, DUSTHIDE, 288),
		gene("Diaphanous", RARE, AETHER, 321, VEILSPUN, 66),
		gene("Eclipse", RARE, MODERN, 421, CIRRUS, 439, EVERLUX, 353, SANDSURGE, 472, UNDERTIDE, 422, VEILSPUN, 423),
		gene("Eclosion", LIMITED, EVERLUX, 361),
		...
		gene("Firefly", LIMITED, MODERN, 22, ABERRATION, 85, AETHER, 328, AURABOA, 232, SANDSURGE, 473, UNDERTIDE, 253, VEILSPUN, 61),
		...
		gene("Flames", LIMITED, CIRRUS, 441),
		gene("Flecks", LIMITED, MODERN, 103, ABERRATION, 104, AETHER, 323, SANDSURGE, 474, UNDERTIDE, 112, VEILSPUN, 64),
		gene("Flutter", LIMITED, AETHER, 141, EVERLUX, 355),
		gene("Frills", RARE, ABERRATION, 86),
		gene("Gecko", UNCOMMON, MODERN, 411, ABERRATION, 412, AETHER, 413, AURABOA, 414, BANESCALE, 415, DUSTHIDE, 416, EVERLUX, 359, GAOLER, 417, SANDSURGE, 418, UNDERTIDE, 419, VEILSPUN, 420),
		gene("Gembond", UNCOMMON, MODERN, 4, AETHER, 137, DUSTHIDE, 287, EVERLUX, 362, SANDSURGE, 176, UNDERTIDE, 123),
		gene("Ghost", UNCOMMON, MODERN, 20, ABERRATION, 88, AETHER, 324, BANESCALE, 47, CIRRUS, 442, DUSTHIDE, 278, GAOLER, 25, UNDERTIDE, 121, VEILSPUN, 131),
		...
		gene("Gnarlhorns", RARE, CIRRUS, 444, GAOLER, 27, SANDSURGE, 467),
		...
		gene("Kumo", COMMON, ABERRATION, 80, CIRRUS, 445, EVERLUX, 364, SANDSURGE, 175),
		gene("Lace", UNCOMMON, MODERN, 16, AETHER, 142, BANESCALE, 44, SANDSURGE, 187),
		gene("Mandibles", LIMITED, AETHER, 143, DUSTHIDE, 283, EVERLUX, 365, SANDSURGE, 471),
		gene("Medusa", RARE, ABERRATION, 430, AETHER, 326, AURABOA, 218, CIRRUS, 446, UNDERTIDE, 255, VEILSPUN, 393),
		gene("Mist", RARE, CIRRUS, 448),
		gene("Mistral", LIMITED, AETHER, 428, BANESCALE, 273, EVERLUX, 429, UNDERTIDE, 272),
		...
		gene("Okapi", UNCOMMON, MODERN, 9, CIRRUS, 447, DUSTHIDE, 284, SANDSURGE, 182, UNDERTIDE, 129, VEILSPUN, 59),
		...
		gene("Paradise", UNCOMMON, AURABOA, 219, CIRRUS, 449, EVERLUX, 367),
		gene("Peacock", COMMON, MODERN, 24, ABERRATION, 90, AURABOA, 237, BANESCALE, 106, CIRRUS, 450, EVERLUX, 368, SANDSURGE, 191, VEILSPUN, 60),
		...
		gene("Polkadot", LIMITED, MODERN, 168, ABERRATION, 79, AURABOA, 238, DUSTHIDE, 293, EVERLUX, 370, SANDSURGE, 475),
		gene("Polypore", LIMITED, ABERRATION, 82, CIRRUS, 451),
		gene("Porcupine", LIMITED, AETHER, 330, AURABOA, 221, BANESCALE, 49, UNDERTIDE, 256),
		gene("Pufferfish", UNCOMMON, UNDERTIDE, 127),
		gene("Quagga", COMMON, CIRRUS, 439),
		gene("Remora", RARE, UNDERTIDE, 119),
		gene("Ringlets", UNCOMMON, MODERN, 23, BANESCALE, 40, DUSTHIDE, 294, GAOLER, 30, UNDERTIDE, 120),
		gene("Rift", UNCOMMON, EVERLUX, 371),
		gene("Riot", LIMITED, ABERRATION, 211, DUSTHIDE, 349, GAOLER, 212, VEILSPUN, 348),
		gene("Rockbreaker", LIMITED, ABERRATION, 390, AURABOA, 244, EVERLUX, 391, SANDSURGE, 245),
		gene("Runes", UNCOMMON, MODERN, 14, CIRRUS, 462, EVERLUX, 372, GAOLER, 32, SANDSURGE, 178, UNDERTIDE, 114, VEILSPUN, 57),
		gene("Sailfin", RARE, AETHER, 331, AURABOA, 222, CIRRUS, 452, UNDERTIDE, 130),
		gene("Scales", LIMITED, MODERN, 15, ABERRATION, 92, AETHER, 147, AURABOA, 239, CIRRUS, 433, EVERLUX, 373, UNDERTIDE, 257),
		...
		gene("Skeletal", LIMITED, ABERRATION, 204, BANESCALE, 45, CIRRUS, 453),
		gene("Smirch", LIMITED, MODERN, 19, ABERRATION, 205, AETHER, 150, SANDSURGE, 192, UNDERTIDE, 259, VEILSPUN, 394),
		gene("Smoke", UNCOMMON, MODERN, 7, AETHER, 151, AURABOA, 240, DUSTHIDE, 297, EVERLUX, 375, GAOLER, 28, SANDSURGE, 469, UNDERTIDE, 260),
		gene("Soap", RARE, MODERN, 105, AETHER, 338, BANESCALE, 159, GAOLER, 388, SANDSURGE, 180, UNDERTIDE, 124, VEILSPUN, 395),
		gene("Space", RARE, AETHER, 149, EVERLUX, 376),
		gene("Sparkle", UNCOMMON, MODERN, 97, ABERRATION, 96, AETHER, 152, BANESCALE, 98, CIRRUS, 461, DUSTHIDE, 292, EVERLUX, 377, GAOLER, 99, SANDSURGE, 193, UNDERTIDE, 122, VEILSPUN, 100),
		gene("Spectre", RARE, CIRRUS, 454, SANDSURGE, 188),
		...
		gene("Spores", RARE, AETHER, 332, CIRRUS, 459, DUSTHIDE, 295, EVERLUX, 379, SANDSURGE, 408),
		...
		gene("Thorns", UNCOMMON, ABERRATION, 208, AETHER, 333, AURABOA, 226, BANESCALE, 344, CIRRUS, 455, DUSTHIDE, 345, EVERLUX, 381, GAOLER, 346, SANDSURGE, 347, UNDERTIDE, 263, VEILSPUN, 68),
		gene("Thundercrack", LIMITED, ABERRATION, 311, BANESCALE, 476, CIRRUS, 477, GAOLER, 195, SANDSURGE, 194, VEILSPUN, 312),
		...
		gene("Topscale", LIMITED, CIRRUS, 456),
		gene("Trickmurk", LIMITED, AETHER, 271, BANESCALE, 426, UNDERTIDE, 427, VEILSPUN, 270),
		gene("Trimmings", COMMON, BANESCALE, 39),
		gene("Underbelly", COMMON, MODERN, 5, ABERRATION, 132, AETHER, 144, AURABOA, 228, BANESCALE, 52, CIRRUS, 434, DUSTHIDE, 275, EVERLUX, 358, GAOLER, 31, SANDSURGE, 171, UNDERTIDE, 109, VEILSPUN, 70),
		gene("Veil", RARE, DUSTHIDE, 296),
		gene("Veined", LIMITED, MODERN, 38, ABERRATION, 91, AETHER, 335, GAOLER, 2, UNDERTIDE, 113, VEILSPUN, 134),
		gene("Warrior", LIMITED, AURABOA, 478, BANESCALE, 313, CIRRUS, 479, DUSTHIDE, 480, SANDSURGE, 314, VEILSPUN, 315),
		gene("Wavecrest", LIMITED, AURABOA, 431, DUSTHIDE, 300, EVERLUX, 432, UNDERTIDE, 301),
		gene("Weathered", LIMITED, GAOLER, 35),
		gene("Whiskers", UNCOMMON, AETHER, 154, DUSTHIDE, 291, EVERLUX, 382, GAOLER, 389, SANDSURGE, 468),
		gene("Willow", UNCOMMON, AURABOA, 227, CIRRUS, 457),
		gene("Wintercoat", UNCOMMON, GAOLER, 34),
		gene("Wish", RARE, MODERN, 213, AETHER, 155, EVERLUX, 383),
		gene("Wool", COMMON, CIRRUS, 458, EVERLUX, 384),
