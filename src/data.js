...
export const GENES = freeze({
	primary: freeze([
		...
		gene("Varnish", COMMON, AETHER, 332, AURABOA, 261, CIRRUS, 435, DUSTHIDE, 316, GAOLER, 381, EVERLUX, 375, SANDSURGE, 442, UNDERTIDE, 276),
	...
	secondary: freeze([
		...
		gene("Lacquer", COMMON, AETHER, 328, AURABOA, 241, CIRRUS, 435, DUSTHIDE, 316, EVERLUX, 376, GAOLER, 382, SANDSURGE, 442, UNDERTIDE, 276),
