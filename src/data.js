...
export const GENES = freeze({
	primary: freeze([
		...
		gene("Bar", UNCOMMON, MODERN, 6, ABERRATION, 89, AETHER, 150, AURABOA, 238, BANESCALE, 181, CIRRUS, 417, DUSTHIDE, 292, EVERLUX, 346, GAOLER, 34, UNDERTIDE, 117, VEILSPUN, 145),
		gene("Basic"),
		...
		gene("Checkers", COMMON, MODERN, 412, AETHER, 319, DUSTHIDE, 293, GAOLER, 378, UNDERTIDE, 127),
		...
		gene("Ragged", UNCOMMON, BANESCALE, 56, CIRRUS, 431),
		...
		gene("Skink", LIMITED, MODERN, 15, ABERRATION, 229, AETHER, 161, BANESCALE, 52, CIRRUS, 437, DUSTHIDE, 315, EVERLUX, 367, GAOLER, 177, VEILSPUN, 67),
		...
		gene("Varnish", COMMON, AETHER, 332, AURABOA, 261, CIRRUS, 435, DUSTHIDE, 316, GAOLER, 381, EVERLUX, 375, UNDERTIDE, 276),
	...
	secondary: freeze([
		...
		gene("Chess", COMMON, MODERN, 412, AETHER, 320, DUSTHIDE, 293, GAOLER, 379, UNDERTIDE, 127),
		...
		gene("Daub", UNCOMMON, MODERN, 7, ABERRATION, 89, AETHER, 150, AURABOA, 238, BANESCALE, 181, CIRRUS, 417, DUSTHIDE, 292, EVERLUX, 348, GAOLER, 34, UNDERTIDE, 117, VEILSPUN, 145),
		...
		gene("Lacquer", COMMON, AETHER, 328, AURABOA, 241, CIRRUS, 435, DUSTHIDE, 316, EVERLUX, 376, GAOLER, 382),
		...
		gene("Spinner", LIMITED, MODERN, 16, ABERRATION, 229, AETHER, 161, BANESCALE, 52, CIRRUS, 437, DUSTHIDE, 315, EVERLUX, 367, GAOLER, 176, VEILSPUN, 68),
		...
		gene("Tear", UNCOMMON, BANESCALE, 56, CIRRUS, 431),
	...
	tertiary: freeze([
		...
		gene("Eclipse", RARE, MODERN, 421, CIRRUS, 439, EVERLUX, 353, UNDERTIDE, 422, VEILSPUN, 423),
		...
		gene("Spores", RARE, AETHER, 332, CIRRUS, 459, DUSTHIDE, 295, EVERLUX, 379),
		...
		gene("Whiskers", UNCOMMON, AETHER, 154, DUSTHIDE, 291, EVERLUX, 382, GAOLER, 389),
